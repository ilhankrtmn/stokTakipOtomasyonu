...
public class UrunEkleme extends JFrame {
    ...
    public UrunEkleme() {
        ...
        l4 = new JLabel("Ürün Ebatları: ");
        l4.setBounds(x, 170, w, h);
        l5 = new JLabel("Çalgı Türü: ");
        l5.setBounds(x, 130, w, h);
        ...
        String[] kalite = {"Sıfır", "2.el"};
        String[] boyut = {"1/8","1/4","1/2","3/4","4/4"};
        String[] tur = {"Vurmalı", "Nefesli", "Tuşlu", "Telli", "Yaylı"};
        JComboBox ukalite, uboyutu, uturu;
        ukalite = new JComboBox(kalite);
        ukalite.setBounds(x + 110, 90, w + 10, h);
        uboyutu = new JComboBox(boyut);
        uboyutu.setBounds(x + 110, 170, w + 10, h);
        uturu = new JComboBox(tur);
        uturu.setBounds(x + 110, 130, w + 10, h);
        ...
        ukaydet.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String urun_id, urun_adi, urun_kalitesi, urun_turu, urun_boyutu,
                ...
                urun_sqlsorgu = "INSERT INTO stok (urun_ıd,urun_adi,urun_kalitesi,urun_turu,urun_boyutu," +
                        ...
                        "VALUES(" + urun_id + ",'" + urun_adi + "'," + "'" + urun_kalitesi + "'," + "'" +
        ...
        uguncelle.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                urun_satis_fiyati = usatisfiyati.getText();
                stok_adedi = ustokadedi.getText();
                urun_sqlsorgu = "UPDATE stok SET urun_ıd=" + urun_id +
                        ",urun_adi='" + urun_adi +
                        ...
                        ",stok_adedi='" + stok_adedi + "' WHERE urun_ıd=" + urun_id;
        ...
        ukayitsil.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String urun_id, per_sqlsorgu;
                urun_id = uid.getText();
                // DELETE FROM ogrenci WHERE
                per_sqlsorgu = "DELETE FROM stok WHERE urun_ıd=" + urun_id;
        ...
        Object[] ukolonlar = {"Ürün ID", "Ürün Adı", "Ürün Kalitesi", "Çalgı Türü", "Ürün Ebatları",
